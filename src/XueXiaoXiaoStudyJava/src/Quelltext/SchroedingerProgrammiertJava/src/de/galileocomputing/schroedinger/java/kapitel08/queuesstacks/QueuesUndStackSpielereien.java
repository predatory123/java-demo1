package XueXiaoXiaoStudyJava.src.Quelltext.SchroedingerProgrammiertJava.src.de.galileocomputing.schroedinger.java.kapitel08.queuesstacks;

import java.util.LinkedList;
import java.util.Queue;
import java.util.Stack;

import XueXiaoXiaoStudyJava.src.Quelltext.SchroedingerProgrammiertJava.src.de.galileocomputing.schroedinger.java.kapitel08.schuhetester.SchuhPaar;
