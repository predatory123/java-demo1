...
public class SAX {
	...
	private static class MusikSammlungHandler extends DefaultHandler {
		...
		public void startElement(String uri, String localName,
			...
			if (Konstanten.ELEMENT_ALBUM.equals(this.aktuellesElement)) {
				System.out.println("Titel: " + attributes.getValue(Konstanten.ATTRIBUT_ALBUM_TITEL));
				this.albenAnzahl++;
			}
		}
		...
		public void characters(char[] character, int start, int laenge)
			...
			case Konstanten.ELEMENT_KUENSTLER_NAME:
				System.out.println("Künstler: " + String.valueOf(character, start, laenge).trim());
				break;
			case Konstanten.ELEMENT_VEROEFFENTLICHT:
